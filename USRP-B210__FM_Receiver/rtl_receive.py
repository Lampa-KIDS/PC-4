...
class rtl_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = Range(80, 110, 0.1, 104, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 105e3, 1e3, firdes.WIN_HAMMING, 6.76))
        self.qtgui_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_sink_x_0_0.set_frequency_range(0, self.samp_rate/self.decimation)
